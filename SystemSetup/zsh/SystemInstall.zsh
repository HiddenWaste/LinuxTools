...
read -p "Whoa Nelly, What kinda user are ya anyways? (main, dev)" installType
echo "Alright then partner, we'll be set'in up a $installType system today."

# echo $SCRIPT_DIR # Debug print
echo "We gotta start with the basics, make sure your horse is taken care of"
